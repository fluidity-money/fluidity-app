...
const MobileNavModal = ({ navLinks }: IMobileNavModalProps) => {
  ...
  //./srchttps://app-cdn.fluidity.money/surfing/assets/images/triangleDown.svg
  return (
    <div className={styles.container}>
      <div className={styles.imgContainer}>
        <a href={"/"}>
          <img src="./srchttps://app-cdn.fluidity.money/surfing/assets/images/logos/.png" alt="logo" />
        </a>
      </div>
