...
const getBottleIcon = (rarity: Rarity, tier?: number) => {
  if (!tier) {
    switch (rarity) {
      ...
      case Rarity.Rare: return BOTTLE_RARE
      case Rarity.UltraRare: return BOTTLE_ULTRA_RARE
      case Rarity.Legendary: return BOTTLE_LEGENDARY
    }
  }
  ...
  switch (rarity) {
    case Rarity.Common:
      switch (tier) {
        case 1: return BOTTLE_1_COMMON
        case 2: return BOTTLE_2_COMMON
        case 3: return BOTTLE_3_COMMON
        case 4: return BOTTLE_4_COMMON
      }
    case Rarity.Uncommon:
      switch (tier) {
        case 1: return BOTTLE_1_UNCOMMON
        case 2: return BOTTLE_2_UNCOMMON
        case 3: return BOTTLE_3_UNCOMMON
        case 4: return BOTTLE_4_UNCOMMON
      }
    case Rarity.Rare:
      switch (tier) {
        case 1: return BOTTLE_1_RARE
        case 2: return BOTTLE_2_RARE
        case 3: return BOTTLE_3_RARE
        case 4: return BOTTLE_4_RARE
      }
    case Rarity.UltraRare:
      switch (tier) {
        case 1: return BOTTLE_1_ULTRA_RARE
        case 2: return BOTTLE_2_ULTRA_RARE
        case 3: return BOTTLE_3_ULTRA_RARE
        case 4: return BOTTLE_4_ULTRA_RARE
      }
    case Rarity.Legendary:
      switch (tier) {
        case 1: return BOTTLE_1_LEGENDARY
        case 2: return BOTTLE_2_LEGENDARY
        case 3: return BOTTLE_3_LEGENDARY
        case 4: return BOTTLE_4_LEGENDARY
      }
  }
}
