  ...
  >
    <div className="spread-center">
      <div className="single-line">
        <img style={{ width: "1.25em" }} src={"https://frontend-old.fluidity.money/images/icons/circle1.svg"} />
        <Text prominent size="sm">
          Copy Your Link.
        </Text>
      </div>
      <div className="single-line">
        <img style={{ width: "1.25em" }} src={"https://frontend-old.fluidity.money/images/icons/circle2.svg"} />
        <Text prominent size="sm">
    ...
    <div className="how-it-works-warning-container">
      <img
        ...
        src="https://frontend-old.fluidity.money/images/icons/circleInfo.svg"
      />
