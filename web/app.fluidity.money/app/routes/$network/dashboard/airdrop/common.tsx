...
const tutorialContent: {
  ...
  "0": {
    ...
    desc: "Welcome to the Fluidity Airdrop V3! Use Fluid Assets and earn Loot Bottles and $FLY rewards. Loot Bottles contain $FLUID tokens. They have different rarities, from common to legendary. The higher the rarity, the more $FLUID tokens it contains. ",
