...
function ErrorBoundary() {
  return (
    ...
    >
      <img src="https://frontend-old.fluidity.money/images/logoMetallic.png" alt="" style={{ height: "40px" }} />
...
> = {
  arbitrum: {
    name: "ARB",
    icon: <img src="https://frontend-old.fluidity.money/assets/chains/arbIcon.svg" />,
  },
  solana: {
    name: "SOL",
    icon: <img src="https://frontend-old.fluidity.money/assets/chains/solanaIcon.svg" />,
  },
  sui: {
    name: "SUI",
    icon: <img src="https://frontend-old.fluidity.money/assets/chains/suiIcon.svg" />,
  },
};
        ...
        <div id="flu-logo">
          <Link to={"./home"}>
            <img
              ...
              src="https://frontend-old.fluidity.money/images/outlinedLogo.svg"
              alt="Fluidity"
            />
          </Link>
          <ChainSelectorButton
        ...
        <footer id="flu-socials" className="hide-on-mobile pad-main">
          ...
          <section>
            ...
            <a
              ...
              target="_blank"
            >
              <img src={"https://frontend-old.fluidity.money/images/socials/twitter.svg"} alt={"Twitter"} />
            </a>
            ...
            <a
              ...
              target="_blank"
            >
              <img src={"https://frontend-old.fluidity.money/images/socials/discord.svg"} alt={"Discord"} />
            </a>
            ...
            <a
              ...
              target="_blank"
            >
              <img src={"https://frontend-old.fluidity.money/images/socials/telegram.svg"} alt={"Telegram"} />
            </a>
            ...
            <a
              ...
              target="_blank"
            >
              <img src={"https://frontend-old.fluidity.money/images/socials/linkedin.svg"} alt={"LinkedIn"} />
            </a>
          </section>
        </footer>
