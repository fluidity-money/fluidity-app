...
[ -z "$FLU_ETHEREUM_WORKER_PRIVATE_KEY_DAI" ] && warn "FLU_ETHEREUM_WORKER_PRIVATE_KEY_DAI not set!"
[ -z "$FLU_ETHEREUM_WORKER_PRIVATE_KEY_USDC" ] && warn "FLU_ETHEREUM_WORKER_PRIVATE_KEY_USDC not set!"
[ -z "$FLU_ETHEREUM_WORKER_PRIVATE_KEY_USDT" ] && warn "FLU_ETHEREUM_WORKER_PRIVATE_KEY_USDT not set!"
