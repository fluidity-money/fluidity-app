...
export \
	FLU_ETHEREUM_WORKER_PRIVATE_KEY_LIST="$FLU_ETHEREUM_TOKEN_NAME_USDT:$FLU_ETHEREUM_WORKER_PRIVATE_KEY_USDT,$FLU_ETHEREUM_TOKEN_NAME_USDC:$FLU_ETHEREUM_WORKER_PRIVATE_KEY_USDC,$FLU_ETHEREUM_TOKEN_NAME_USDC:$FLU_ETHEREUM_WORKER_PRIVATE_KEY_DAI,$FLU_ETHEREUM_TOKEN_NAME_TUSD:$FLU_ETHEREUM_WORKER_PRIVATE_KEY_TUSD,$FLU_ETHEREUM_TOKEN_NAME_TUSD:$FLU_ETHEREUM_WORKER_PRIVATE_KEY_FEI,$FLU_ETHEREUM_TOKEN_NAME_TUSD:$FLU_ETHEREUM_WORKER_PRIVATE_KEY_FRAX,$FLU_ETHEREUM_TOKEN_NAME_TUSD:$FLU_ETHEREUM_WORKER_PRIVATE_KEY_UST"
	
export \
	BALANCER_VAULT_CONTRACT="0xBA12222222228d8Ba445958a75a0704d566BF2C8"
	
export FLU_ETHEREUM_APPLICATION_CONTRACTS="$BALANCER_VAULT_CONTRACT"
