...
export \
	FLU_ETHEREUM_TOKENS_LIST=$FLU_ETHEREUM_CONTRACT_ADDR_FUSDT:$FLU_ETHEREUM_TOKEN_NAME_USDT:$FLU_ETHEREUM_TOKEN_DECIMALS_USDT,$FLU_ETHEREUM_CONTRACT_ADDR_FUSDC:$FLU_ETHEREUM_TOKEN_NAME_USDC:$FLU_ETHEREUM_TOKEN_DECIMALS_USDT,$FLU_ETHEREUM_CONTRACT_ADDR_FDAI:$FLU_ETHEREUM_TOKEN_NAME_DAI:$FLU_ETHEREUM_TOKEN_DECIMALS_DAI,$FLU_ETHEREUM_CONTRACT_ADDR_FTUSD:$FLU_ETHEREUM_TOKEN_NAME_TUSD:$FLU_ETHEREUM_TOKEN_DECIMALS_TUSD,$FLU_ETHEREUM_CONTRACT_ADDR_FFEI:$FLU_ETHEREUM_TOKEN_NAME_FEI:$FLU_ETHEREUM_TOKEN_DECIMALS_FEI,$FLU_ETHEREUM_CONTRACT_ADDR_FFRAX:$FLU_ETHEREUM_TOKEN_NAME_FRAX:$FLU_ETHEREUM_TOKEN_DECIMALS_FRAX,$FLU_ETHEREUM_CONTRACT_ADDR_FUST:$FLU_ETHEREUM_TOKEN_NAME_UST:$FLU_ETHEREUM_TOKEN_DECIMALS_UST
