...
export \
	FLU_ETHEREUM_TOKENS_LIST=$FLU_ETHEREUM_CONTRACT_ADDR_TUSD:$FLU_ETHEREUM_TOKEN_NAME_TUSD:$FLU_ETHEREUM_TOKEN_DECIMALS_TUSD,$FLU_ETHEREUM_CONTRACT_ADDR_DAI:$FLU_ETHEREUM_TOKEN_NAME_DAI:$FLU_ETHEREUM_TOKEN_DECIMALS_DAI,$FLU_ETHEREUM_CONTRACT_ADDR_USDT:$FLU_ETHEREUM_TOKEN_NAME_USDT:$FLU_ETHEREUM_TOKEN_DECIMALS_USDT,$FLU_ETHEREUM_CONTRACT_ADDR_USDC:$FLU_ETHEREUM_TOKEN_NAME_USDC:$FLU_ETHEREUM_TOKEN_DECIMALS_USDC

# prize pool specific, uses an extra parameter for the underlying token addresses
export \
	FLU_ETHEREUM_TOKENS_LIST_PRIZE_POOL=$FLU_ETHEREUM_CONTRACT_ADDR_FTUSD:$FLU_ETHEREUM_TOKEN_NAME_TUSD:$FLU_ETHEREUM_TOKEN_DECIMALS_TUSD:$FLU_ETHEREUM_CONTRACT_ADDR_TUSD,$FLU_ETHEREUM_CONTRACT_ADDR_FDAI:$FLU_ETHEREUM_TOKEN_NAME_DAI:$FLU_ETHEREUM_TOKEN_DECIMALS_DAI:$FLU_ETHEREUM_CONTRACT_ADDR_DAI,$FLU_ETHEREUM_CONTRACT_ADDR_FUSDT:$FLU_ETHEREUM_TOKEN_NAME_USDT:$FLU_ETHEREUM_TOKEN_DECIMALS_USDT:$FLU_ETHEREUM_CONTRACT_ADDR_USDT,$FLU_ETHEREUM_CONTRACT_ADDR_FUSDC:$FLU_ETHEREUM_TOKEN_NAME_USDC:$FLU_ETHEREUM_TOKEN_DECIMALS_USDC:$FLU_ETHEREUM_CONTRACT_ADDR_USDC
