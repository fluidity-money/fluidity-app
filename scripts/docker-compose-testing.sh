...
export \
	FLU_FRONTEND_API_URL=http://localhost:8081 \
	FLU_FRONTEND_WS_URL=ws://localhost:8081/updates \
	FLU_FRONTEND_CHAIN_ID=31337 \
	FLU_FRONTEND_TOKEN_FILE=testing-tokens.json \
	FLU_FRONTEND_GETH_URL=http://localhost:8545
