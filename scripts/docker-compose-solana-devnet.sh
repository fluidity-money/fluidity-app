...
export \
        FLU_SOLANA_TOKENS_LIST=$FLU_SOLANA_FLUID_MINT_PUBKEY_USDC:$FLU_SOLANA_OBLIGATION_PUBKEY_USDC:$FLU_SOLANA_RESERVE_PUBKEY_USDC:$FLU_SOLANA_PYTH_PUBKEY_USDC:$FLU_SOLANA_SWITCHBOARD_PUBKEY_USDC:$FLU_SOLANA_TOKEN_DECIMALS_USDC,$FLU_SOLANA_FLUID_MINT_PUBKEY_USDT:$FLU_SOLANA_OBLIGATION_PUBKEY_USDT:$FLU_SOLANA_RESERVE_PUBKEY_USDT:$FLU_SOLANA_PYTH_PUBKEY_USDT:$FLU_SOLANA_SWITCHBOARD_PUBKEY_USDT:$FLU_SOLANA_TOKEN_DECIMALS_USDT
