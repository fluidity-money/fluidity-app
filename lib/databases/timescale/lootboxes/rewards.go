...
// fetch the 10 addresses with the highest lootboxes earned during the given period on kyberswap
func GetTopKyberswapUsersByLootboxCount(startTime, endTime time.Time) []UserLootboxCount {
	timescaleClient := timescale.Client()
