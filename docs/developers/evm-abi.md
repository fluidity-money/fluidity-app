...
The following ABIs can be compiled in the repository (using `make`.)
...
### AAVE LiquidityProvider

Implemented form of LiquidityProvider supporting AAVE.

```
  "contractName": "AaveLiquidityProvider",
  "abi": [
    {
      "inputs": [],
      "name": "aToken_",
    ...
    {
      "inputs": [],
      "name": "lendingPoolAddresses_",
      "outputs": [
        {
          "internalType": "contract LendingPoolAddressesProviderInterface",
          "name": "",
          "type": "address"
        }
      ],
...
```
{
  "contractName": "CompoundLiquidityProvider",
  "abi": [
    {
      "inputs": [
        {
