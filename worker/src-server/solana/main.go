...
import (
	...
	"github.com/fluidity-money/fluidity-app/src/worker/solana/fluidity"
	"github.com/fluidity-money/fluidity-app/src/worker/solana/solend"

	prizePool "github.com/fluidity-money/fluidity-app/src/microservice-solana-prize-pool/solana"
...
const (
	...
	// SolanaTransactionFeeNormalised that's hardcoded to make the system more
	// consistent in reward payout
	SolanaTransactionFeeNormalised = 0.00025

	// SolanaComputeBudget is Solana's limit on compute units used by a program
	SolanaComputeBudget = 200000

	// PayoutVariant is the number of the instruction that's called to trigger
	// a reward payout
...
func main() {
	...
	solanaTransactionFeeNormalised := new(big.Rat).SetFloat64(
