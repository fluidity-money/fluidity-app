...
@external
@view
def getPastTotalSupply(t: uint256 = block.timestamp) -> uint256:
    """
...
@external
def delegateBySig(delegatee: address, nonce: uint256, expiry: uint256, v: uint256, r: bytes32, s: bytes32):
    raise "Not implemented"
