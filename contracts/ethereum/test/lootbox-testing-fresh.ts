...
import {
  ...
  deposit,
  expectDeposited,
  expectRedeemableWithDrift,
  redeem,
  expectWithinSlippage } from "./lootbox";
...
describe("LootboxStaking fresh", async () => {
  ...
  it("should lock up 2000000 test token 1 and 2000000 test token 2", async() => {
    ...
    console.log(`depositToken fuck you fuck you fuck you: ${depositToken}`);
