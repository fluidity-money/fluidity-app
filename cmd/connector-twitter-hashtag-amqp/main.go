...
import (
	...
	"github.com/fluidity-money/fluidity-app/cmd/connector-twitter-hashtag-amqp/lib"
)
...
func main() {
	...
	tweets, errors, err := connector_twitter_fluidity_hashtag_amqp.RunStreamTweets(
		twitterBearerToken,
		hashtags...,
	)
