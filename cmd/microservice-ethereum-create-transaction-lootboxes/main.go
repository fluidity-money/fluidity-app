...
func protocolMultiplier(application applications.Application) *big.Rat {
	switch application {
	case applications.ApplicationJumper, applications.ApplicationUniswapV3, applications.ApplicationTraderJoe, applications.ApplicationCamelot, applications.ApplicationCamelotV3, applications.ApplicationRamses:
