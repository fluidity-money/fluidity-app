...
func GetApplicationTransfers(logs []ethereum.Log, transactions []ethereum.Transaction, blockHash ethereum.Hash, applicationContracts []string, classifyApplicationLogTopic func(topic string) applications.Application) (map[ethereum.Hash][]worker.EthereumApplicationTransfer) {
