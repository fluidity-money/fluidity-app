...
func GetAldrinFees(solanaClient *solanaRpc.Client, transaction types.TransactionResult, aldrinProgramID string, fluidTokens map[string]string) (feesPaid *big.Rat, err error) {
